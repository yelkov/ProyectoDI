...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("img/1486505259-estate-home-house-building-property-real_81428.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.panPrincipal.setMinimumSize(QtCore.QSize(1024, 670))
        ...
        self.gridLayout_3.addWidget(self.btnGrabarcli, 0, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btnDelcli, 0, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btnModifcli, 0, 1, 1, 1)
