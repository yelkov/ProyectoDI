...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("C:/Users/a23yelkovq/.designer/backup/img/icono.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.gridLayout.addItem(spacerItem2, 1, 11, 1, 1)
