...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        self.gridLayout.addItem(spacerItem5, 1, 20, 1, 1)
        ...
        self.gridLayout.addItem(spacerItem11, 3, 18, 1, 1)
        ...
        icon2.addPixmap(QtGui.QPixmap(".\\\\templates\\../img/salir.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
